...
%==========================================================================
% subroutine to calculate b matrix
% 
%   input:  gradient structure
%
%   output: b-matrix
%           capital delta
%
...
% off-diagonal terms
brp = gsq*(Gdr*Gdp*tau22+(Gdr*Gcp+Gcr*Gdp)*tau23+Gcr*Gcp*tau33+...
    Grdp*Gpdp*tau55rp+Grdp*Gpe*tau5rp6m+Gro*Gpdp*tau5rp71+Gpe*Gro*tau6m71);
bpr = brp;

brs = gsq*((Gdr*Gcs+Gcr*Gds)*tau23+1/2*Gdr*Gsl2*tau24+...
    1/2*Gdr*Grf*tau25s+Gcr*Gcs*tau33+Gcr*1/2*Gsl2*tau34+...
    1/2*Gcr*Grf*tau35s+1/2*Grdp*Grf*tau55rp+1/2*Gro*Grf*tau5s71);
bsr = brs;

bsp = gsq*(Gdp*Gds*tau22+(Gds*Gcp+Gdp*Gcs)*tau23+1/2*Gdp*Gsl2*tau24+...
    1/2*Gdp*Grf*tau25s+Gcp*Gcs*tau33+1/2*Gcp*Gsl2*tau34+...
    1/2*Gcp*Grf*tau35s+1/2*Gpdp*Grf*tau55rp+1/2*Gpe*Grf*tau5s6m);
bps = bsp;
